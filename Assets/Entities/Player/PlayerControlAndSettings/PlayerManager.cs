...
public class PlayerManager : Entity
{
    ...
    public void InventoryItems(String listType, Boolean clean = false)
    {
        ...
        List<Ingredient> currentInventory = listType == "flavor" ? flavorInventory.Cast<Ingredient>().ToList() : 
                                             listType == "ability" ? abilityInventory.Cast<Ingredient>().ToList() : 
        ...
        foreach (var ingredient in currentInventory)
        {
            ...
            {
                draggableItemComponent.ingredient = ingredient; // Assuming DraggableItem has an 'ingredient' field
            }
