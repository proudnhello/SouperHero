...
public class DownscalePixelRenderPass : ScriptableRenderPass
{
    ...
    public DownscalePixelRenderPass(ShaderSettings settings)
    {
        pixelateMaterial = CoreUtils.CreateEngineMaterial(settings.DownscaleShader);
    ...
    public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
    {
        ...
        descriptor.width = (int)settings.Dimensions.x;
        descriptor.height = (int)settings.Dimensions.y;
